...
func (m *MockCategoryRepository) Browse(search *model.BrowseCategory) ([]model.Category, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Browse", search)
...
func (mr *MockCategoryRepositoryMockRecorder) Browse(search interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Browse", reflect.TypeOf((*MockCategoryRepository)(nil).Browse), search)
}
